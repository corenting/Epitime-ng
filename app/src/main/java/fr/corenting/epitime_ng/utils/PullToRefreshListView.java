...
public class PullToRefreshListView extends ListView{
    ...
    private SimpleDateFormat lastUpdatedDateFormat = new SimpleDateFormat("dd/MM HH:mm", Locale.FRANCE);
    ...
    private class PTROnItemLongClickListener implements OnItemLongClickListener{
        ...
        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id){
            ...
            return onItemLongClickListener != null && state == State.PULL_TO_REFRESH && onItemLongClickListener.onItemLongClick(adapterView, view, position - getHeaderViewsCount(), id);
